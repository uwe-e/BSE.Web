...
namespace AspNet.Identity.MySQL
{
    ...
    public class UserTable
    {
        ...
        {
			string commandText = "Insert into aspnetusers (UserName, Id, PasswordHash, SecurityStamp) values (@name, @id, @pwdHash, @SecStamp)";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
			string commandText = "Update aspnetusers set UserName = @userName, PasswordHash = @pswHash, SecurityStamp = @secStamp WHERE Id = @userId";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
